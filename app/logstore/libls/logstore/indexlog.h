#ifndef MONOLOG_INDEXLOG_H_
#define MONOLOG_INDEXLOG_H_
...
class indexlog {
 ...
 private:
  void try_allocate_list(uint32_t i) {
    monolog::entry_list* new_list = new monolog::entry_list;
    monolog::entry_list* null_ptr = NULL;
