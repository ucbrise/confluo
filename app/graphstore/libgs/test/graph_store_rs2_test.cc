...
class GraphStoreRS2Test : public testing::Test {
 public:
...
TEST_F(GraphStoreRS2Test, UpdateNodeTest) {
  static const uint64_t kNumNodes = 1000;
  for (size_t num_threads = 1; num_threads <= kMaxThreads; num_threads++) {
    graph_store<read_stalled> gs;
...
TEST_F(GraphStoreRS2Test, AddGetLinkTest) {
  static const uint64_t kNumNodes = 1000;
...
TEST_F(GraphStoreRS2Test, AddNodeLinkTest) {
  static const uint64_t kNumNodes = 1000;
  static const uint64_t kDegree = 10;
