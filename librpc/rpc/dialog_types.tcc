 ...
 *  @generated
 */
#ifndef dialog_TYPES_TCC
#define dialog_TYPES_TCC
    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->type = (rpc_iterator_type)ecast4;
          isset_type = true;
        } else {
          xfer += iprot->skip(ftype);
        }
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->data_type = (rpc_data_type)ecast5;
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->blocks.resize(_size18);
            uint32_t _i22;
            for (_i22 = 0; _i22 < _size18; ++_i22)
            {
              xfer += this->blocks[_i22].read(iprot);
            }
...
uint32_t rpc_record_batch::write(Protocol_* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("blocks", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    std::vector<rpc_record_block> ::const_iterator _iter23;
    for (_iter23 = this->blocks.begin(); _iter23 != this->blocks.end(); ++_iter23)
    {
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->schema.resize(_size28);
            uint32_t _i32;
            for (_i32 = 0; _i32 < _size28; ++_i32)
            {
              xfer += this->schema[_i32].read(iprot);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t rpc_table_info::write(Protocol_* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("schema", ::apache::thrift::protocol::T_LIST, 2);
  {
    ...
    std::vector<rpc_column> ::const_iterator _iter33;
    for (_iter33 = this->schema.begin(); _iter33 != this->schema.end(); ++_iter33)
    {
