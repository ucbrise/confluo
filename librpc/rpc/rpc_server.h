...
class rpc_service_handler : virtual public rpc_serviceIf {
 public:
  ...
  /**
   * Gets more alerts depending on the description
   *
   * @param _return The rpc iterator with the results
   * @param id The identifier of the atomic multilog
   * @param desc The description of handler
   * @throw rpc_invalid_exception If there was a mismatch in handlers
   */
