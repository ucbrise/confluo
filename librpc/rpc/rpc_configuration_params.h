...
size_t rpc_configuration_params::ITERATOR_BATCH_SIZE = configuration_params::dialog_conf.get<size_t>(
    "iterator_batch_size", rpc_constants::DEFAULT_ITERATOR_BATCH_SIZE);

size_t rpc_configuration_params::WRITE_BATCH_SIZE = configuration_params::dialog_conf.get<size_t>(
    "write_batch_size", rpc_constants::DEFAULT_WRITE_BATCH_SIZE);

size_t rpc_configuration_params::READ_BATCH_SIZE = configuration_params::dialog_conf.get<size_t>(
