...
class rpc_invalid_operation(TException):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(rpc_column)
rpc_column.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'type_id', None, None, ),  # 1
    (2, TType.I32, 'type_size', None, None, ),  # 2
    (3, TType.STRING, 'name', 'UTF8', None, ),  # 3
)
all_structs.append(rpc_iterator_descriptor)
rpc_iterator_descriptor.thrift_spec = (
    None,  # 0
...
all_structs.append(rpc_iterator_handle)
rpc_iterator_handle.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'desc', [rpc_iterator_descriptor, None], None, ),  # 1
    (2, TType.STRING, 'data', 'BINARY', None, ),  # 2
    (3, TType.I32, 'num_entries', None, None, ),  # 3
    (4, TType.BOOL, 'has_more', None, None, ),  # 4
)
all_structs.append(rpc_record_block)
rpc_record_block.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'time_block', None, None, ),  # 1
    (2, TType.STRING, 'data', 'BINARY', None, ),  # 2
    (3, TType.I64, 'nrecords', None, None, ),  # 3
)
all_structs.append(rpc_record_batch)
rpc_record_batch.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'blocks', (TType.STRUCT, [rpc_record_block, None], False), None, ),  # 1
    (2, TType.I64, 'nrecords', None, None, ),  # 2
)
all_structs.append(rpc_atomic_multilog_info)
rpc_atomic_multilog_info.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'id', None, None, ),  # 1
    (2, TType.LIST, 'schema', (TType.STRUCT, [rpc_column, None], False), None, ),  # 2
)
all_structs.append(rpc_management_exception)
rpc_management_exception.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'msg', 'UTF8', None, ),  # 1
)
all_structs.append(rpc_invalid_operation)
rpc_invalid_operation.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'msg', 'UTF8', None, ),  # 1
)
