#ifndef CONFLUO_TEST_SCHEMA_TEST_H_
#define CONFLUO_TEST_SCHEMA_TEST_H_
...
TEST_F(SchemaTest, SchemaApplyTest) {
  ...
  ASSERT_TRUE(primitive_types::ULONG_TYPE() == r[0].type());
  ASSERT_FALSE(r[0].is_indexed());

  ASSERT_EQ(1, r[1].idx());
  ASSERT_EQ(tmp.a, r[1].as<bool>());
  ASSERT_TRUE(primitive_types::BOOL_TYPE() == r[1].type());
  ASSERT_FALSE(r[1].is_indexed());

  ASSERT_EQ(2, r[2].idx());
  ASSERT_EQ(tmp.b, r[2].as<int8_t>());
  ASSERT_TRUE(primitive_types::CHAR_TYPE() == r[2].type());
  ASSERT_FALSE(r[2].is_indexed());

  ASSERT_EQ(3, r[3].idx());
  ASSERT_EQ(tmp.c, r[3].as<int16_t>());
  ASSERT_TRUE(primitive_types::SHORT_TYPE() == r[3].type());
  ASSERT_FALSE(r[3].is_indexed());

  ASSERT_EQ(4, r[4].idx());
  ASSERT_EQ(tmp.d, r[4].as<int32_t>());
  ASSERT_TRUE(primitive_types::INT_TYPE() == r[4].type());
  ASSERT_FALSE(r[4].is_indexed());

  ASSERT_EQ(5, r[5].idx());
  ASSERT_EQ(tmp.e, r[5].as<int64_t>());
  ASSERT_TRUE(primitive_types::LONG_TYPE() == r[5].type());
  ASSERT_FALSE(r[5].is_indexed());

  ASSERT_EQ(6, r[6].idx());
  ASSERT_EQ(tmp.f, r[6].as<float>());
  ASSERT_TRUE(primitive_types::FLOAT_TYPE() == r[6].type());
  ASSERT_FALSE(r[6].is_indexed());

  ASSERT_EQ(7, r[7].idx());
  ASSERT_TRUE(primitive_types::DOUBLE_TYPE() == r[7].type());
  ASSERT_EQ(tmp.g, r[7].as<double>());
  ASSERT_FALSE(r[7].is_indexed());

  ASSERT_EQ(8, r[8].idx());
  ASSERT_TRUE(primitive_types::STRING_TYPE(16) == r[8].type());
  ASSERT_FALSE(r[8].is_indexed());
}

#endif /* CONFLUO_TEST_SCHEMA_TEST_H_ */
