#ifndef CONFLUO_TEST_BITMAP_ARRAY_TEST_H_
#define CONFLUO_TEST_BITMAP_ARRAY_TEST_H_

#include "container/bitmap/bitmap_array.h"
#include "bit_utils.h"
...
#endif /* CONFLUO_TEST_BITMAP_ARRAY_TEST_H_ */
